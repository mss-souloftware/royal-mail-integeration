...
/**
 * 
 * Plugin Name: RoaylMail Integeration
 * plugin URI: https://souloftware.com/
 * version:1.0.0
 * Text Domail: lic. M. Sufyan Shaikh 
 * Description: Custom plugin for RoyalMail Integeration with multispet form and perform all functionality with the WordPress dashboard.
 * Author: Souloftware
